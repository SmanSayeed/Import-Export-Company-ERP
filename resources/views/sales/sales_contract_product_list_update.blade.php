...
@section('content')
 ...
 <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Sales Contract Products Update</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
 ...
 @if(count($errors)>0)
              ...
              <form method="post" action="/sales-contract-product-list-edit/{{$data->id}}">
              @csrf
                <div class="row">
                  ...
                  <div class="col-md-4">
                        ...
                        <input  class="form-control form-control-alternative" placeholder="Product Shipping"  type="text" name="sales_pro_shippingmark" value="{{$data->sales_pro_shippingmark}}">
                       </div>
